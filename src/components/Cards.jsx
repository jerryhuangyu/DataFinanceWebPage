...
const Card = ({
  ...
  return (
    <div
      className={`w-[85%] md:w-full mx-auto border shadow-xl flex flex-col p-4 my-10 md:my-4 rounded-lg hover:scale-105 duration-300 ${
        standout ? "bg-gray-100" : "bg-white"
      }`}
    >
      <div className="w-[105px] h-[100px] border-b-[2px] rounded-full mt-[-4rem] mx-auto bg-white"></div>
      <img className={`h-16 mx-auto mt-[-93px]`} src={iconType} alt="single" />
      <h2 className="items-center flex justify-center text-2xl font-bold text-center py-8 h-[120px]">{userType} User</h2>
      ...
      <button
        className={`${styles.buttonBase} green-text bg-black hover:bg-green-400 hover:text-black`}
      >
        {buttonName}
      </button>
    </div>
